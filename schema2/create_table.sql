...
w_zip char(9), 
w_tax decimal(4,2), 
w_ytd decimal(12,2) ) TYPE=RocksDB;
...
h_data varchar(24) ) TYPE=RocksDB;
...
no_w_id smallint not null) TYPE=RocksDB;
...
o_ol_cnt tinyint, 
o_all_local tinyint ) TYPE=RocksDB;
...
ol_dist_info char(24) ) TYPE=RocksDB;
...
i_name varchar(24), 
i_price decimal(5,2), 
i_data varchar(50) ) TYPE=RocksDB;
...
s_data varchar(50) ) TYPE=RocksDB;
